/* MPU9250_BME280 Basic Example Code
 by: Kris Winer
 date: May 1, 2016
...
#define AK8963_ADDRESS  0x0C   //  Address of magnetometer
#endif  
#define BME280_ADDRESS  0x76   // Address of BMP280 altimeter  
...
void setup()
{
  ...
  Wire.begin(0, 400000, true); // set master mode, I2C frequency at 400 kHz back pads
//  Wire.begin(0, 400000, false); // set master mode, I2C frequency at 400 kHz pins 20/21
  delay(1000);
 ...
 // Read the WHO_AM_I register of the BME280 this is a good test of communication
  ...
  if(f == 0x60) { // WHO_AM_I register should always return x60 for the BME280
